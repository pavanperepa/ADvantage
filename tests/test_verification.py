...
from cricket_posts.campaign.poster_adapter import produce_poster
from cricket_posts.campaign.verification import verify_poster, verify_reel
...
def clean_compose_result(tmp_path_factory):
    ...
    _, compose_result = produce_poster(_request(), workdir=workdir)
